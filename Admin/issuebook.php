	...
	<div class="rapper">
      ...
      <?php
        ...
        $c=0;
         ...
         if(isset($_SESSION['login_user']))
         {
           $sql="SELECT user.username,email,books.id,name,authors,editions,issue,issue_book.return FROM user inner join issue_book ON user.username=issue_book.username inner join books ON issue_book.id=books.id WHERE issue_book.approve ='Yes' ORDER BY `issue_book`.`return` ASC "; 
